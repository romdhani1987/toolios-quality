...
public class LicenseModelObject extends AbstractTableModel {
    private final List<License> licenses = new ArrayList<License>();

    private final String[] header = {"Id", "Name", "Type", "Serial number", "Purchase date", "Expiration date", "Serialized properties", "Computer"};

    public LicenseModelObject() {
        super();
    }
